...
# 
# Source data is with permission from [ExcelisFun](https://www.youtube.com/watch?v=nBu1Bqa1jjs&t=1780s)
...
# [pyjanitor](https://pyjanitor-devs.github.io/pyjanitor/) has a [xlsx_table](https://pyjanitor-devs.github.io/pyjanitor/api/io/#janitor.io.xlsx_table) functions that allows easy extraction of excel tables (under the hood it uses [openpyxl](https://openpyxl.readthedocs.io/en/stable/)):
